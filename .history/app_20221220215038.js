...
const Firebase = require("./firebase/setData");
...
app.get("/user", function (req, res) {
  ...
  admin
    ...
    .then((userData) => {
      ...
      Firebase.createUser({},4173c4a9edff6a1d4850c3e25ed462c0df670cd9218beac91a5f9ae1be57b629);
      res.render("user_account", { user: userData });
    })
    .catch((error) => {
      res.redirect("/login");
    });
