...
class FirebaseData {
  ...
  static async updateAppointment(id, data, key) {
    ...
    const res = await docRef.update({
      ...
      checkedIn:
        checkedIn != data.checkedIn && data.checkedIn != ""
          ? data.checkedIn
          : checkedIn,
      time: time != data.time && data.amount != "" ? data.time : time,
      guestID:
        guestID != data.guestID && data.amount != "" ? data.guestID : guestID,
      location:
        location != data.location && data.amount != ""
          ? data.location
          : location,
      payed: payed != data.payed && data.amount != "" ? data.payed : payed,
    });
  }
}
