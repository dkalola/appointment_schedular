...
class FirebaseData {
  ...
  static async updateAppointment(id, data, key) {
    ...
    const res = await docRef.update({
      amount: amount != data.amount && data.amount != "" ? data.amount : amount,
      checkedIn: checkedIn != data.checkedIn ? data.checkedIn : checkedIn,
      time: time != data.time ? data.time : time,
      guestID: guestID != data.guestID ? data.guestID : guestID,
      location: location != data.location ? data.location : location,
      payed: payed != data.payed ? data.payed : payed,
    });
  }
}
