...
class FirebaseData {
  ...
  static async deleteGuest(id, key) {
    ...
    if (app.empty) {
      ...
      return { status: true, message: "Guest not found!" };
    } else {
  ...
  static async updateAppointment(id, data, key) {
    ...
    if (ap.empty) {
      ...
      const res = await docRef.update({
        amount:
          amount != data.amount && data.amount != "" ? data.amount : amount,
        checkedIn:
        ...
        guestID:
          guestID != data.guestID && data.guestID != ""
            ? data.guestID
            : guestID,
        location:
          location != data.location && data.location != ""
            ? data.location
            : location,
        payed: payed != data.payed && data.payed != "" ? data.payed : payed,
      });
